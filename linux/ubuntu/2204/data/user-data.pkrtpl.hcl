...
autoinstall:
  ...
  identity:
    hostname: ubuntu2204
    username: kishore
    password: $6$x3xHqfCtY7cb.5Zr$/BIDj1zRJj4.2JBxfWOVmpgeeezJaNnfqv1/XQJ4pM3lVv0yXHlThnjLo9Easo1quc609I7tkVOtEs3G7KiVK.
  ssh:
    install-server: true
    allow-pw: true
  packages:
  ...
  late-commands:
    ...
    - echo 'kishore ALL=(ALL) NOPASSWD:ALL' > /target/etc/sudoers.d/kishore
    - curtin in-target --target=/target -- chmod 440 /etc/sudoers.d/kishore
